...
const QCodesysNVType QCodesysNVType::BOOL = QCodesysNVType(0,"BOOL",1,QCodesysNVcmpType::quint8);
const QCodesysNVType QCodesysNVType::BYTE = QCodesysNVType(1,"BYTE",1,QCodesysNVcmpType::quint8);
const QCodesysNVType QCodesysNVType::WORD = QCodesysNVType(2,"WORD",2,QCodesysNVcmpType::quint16);
const QCodesysNVType QCodesysNVType::DWORD = QCodesysNVType(3,"DWORD",4,QCodesysNVcmpType::quint32);
const QCodesysNVType QCodesysNVType::SINT = QCodesysNVType(4,"SINT",1,QCodesysNVcmpType::qint8);
const QCodesysNVType QCodesysNVType::USINT = QCodesysNVType(5,"USINT",1,QCodesysNVcmpType::quint8);
const QCodesysNVType QCodesysNVType::INT = QCodesysNVType(6,"INT",2,QCodesysNVcmpType::qint16);
const QCodesysNVType QCodesysNVType::UINT = QCodesysNVType(7,"UINT",2,QCodesysNVcmpType::quint16);
const QCodesysNVType QCodesysNVType::DINT = QCodesysNVType(8,"DINT",4,QCodesysNVcmpType::qint32);
...
static QList<QCodesysNVType> defaultList() {
	...
	res.append(QCodesysNVType::BOOL);
	res.append(QCodesysNVType::BYTE);
	res.append(QCodesysNVType::WORD);
	res.append(QCodesysNVType::DWORD);
	res.append(QCodesysNVType::SINT);
	res.append(QCodesysNVType::USINT);
	res.append(QCodesysNVType::INT);
	res.append(QCodesysNVType::UINT);

	res.append(QCodesysNVType::DINT);
...
const QList<QCodesysNVType> QCodesysNVType::typeList (defaultList());

QVariant QCodesysNVType::convertToVariant(const QString & value, QCodesysNVType netType) {
    if (netType == QCodesysNVType::BOOL ||
        netType == QCodesysNVType::BYTE ||
        netType == QCodesysNVType::WORD ||
        netType == QCodesysNVType::DWORD ||
        netType == QCodesysNVType::SINT ||
        netType == QCodesysNVType::USINT ||
        netType == QCodesysNVType::INT ||
        netType == QCodesysNVType::UINT  ||
        netType == QCodesysNVType::DINT ||
        netType == QCodesysNVType::UDINT
    ) {
...
int QCodesysNVTelegram::setVariableTypes(const QStringList & variableStringList) {
...
int QCodesysNVTelegram::setVariableTypes(QString variables)
{
    ...
    return setVariableTypes(variableStringList);
...
void QCodesysNVTelegram::dataVarToString(int index,QString& variableString)
{
    ...
    if (index < variableTypeList.length())
    {
        ...
        else if(variableTypeList[index].varType==QCodesysNVcmpType::qint8 || variableTypeList[index].varType==QCodesysNVcmpType::qint16 || variableTypeList[index].varType==QCodesysNVcmpType::qint32 || variableTypeList[index].varType==QCodesysNVcmpType::qint64)
        {
            qint64 tempData;
            readData(index,tempData);
            variableString.append(QString::number(tempData));
        }
        else if(variableTypeList[index].varType==QCodesysNVcmpType::qfloat || variableTypeList[index].varType==QCodesysNVcmpType::qdouble)
        {
            double tempData;
            readData(index,tempData);
            variableString.append(QString::number(tempData));
