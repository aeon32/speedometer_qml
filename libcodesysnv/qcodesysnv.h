...
public:
    ...
    int setVariableTypes(const QStringList & variables);
...
void QCodesysNVConvert<Type>::convertFromBytes(QByteArray bytes, QCodesysNVType cmpType, Type& variable)
{
    ...
    if(cmpType.varType==QCodesysNVcmpType::quint8)
    {
        quint8 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::qint8)
    {
        qint8 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::quint16)
    {
        quint16 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::qint16)
    {
        qint16 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::quint32)
    {
        quint32 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::qint32)
    {
        qint32 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::quint64)
    {
        quint64 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::qint64)
    {
        qint64 tempVar;
        stream >> tempVar;
        variable = (Type) tempVar;
    }
    else if(cmpType.varType==QCodesysNVcmpType::qfloat)
    {
    ...
    else if(cmpType.varType==QCodesysNVcmpType::qdouble)
    {
