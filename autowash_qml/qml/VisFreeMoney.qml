...
Item {
    ...
    Text {
        id: header_text
        text: "ВНИМАНИЕ! РЕЖИМ \"ПОПОЛНЕНИЕ БАЛАНСА ОПЕРАТОРОМ\""
        font.pixelSize: 31
