...
Rectangle {
    ...
    implicitHeight: Math.max(Screen.pixelDensity * 7, (buttonLabel.implicitHeight + buttonLabel2.implicitHeight) * 1.2)
    ...
    gradient: Gradient {
        GradientStop {
            ...
            color: selected ? "#9090b0" : "#fff"
        }
        GradientStop {
            position: 1
            //Behavior on color {ColorAnimation { duration: 100 }}
            color: selected ? "#d5d5f5" : "#eee" //"#f5f5f5"
        }
    }
